...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim):
		...
		# Q1 architecture
		self.l1 = nn.Linear(state_dim + action_dim, NODES)
		self.l2 = nn.Linear(NODES, NODES)
		self.l3 = nn.Linear(NODES, 1)

		# Q2 architecture
		self.l4 = nn.Linear(state_dim + action_dim, NODES)
		self.l5 = nn.Linear(NODES, NODES)
		self.l6 = nn.Linear(NODES, 1)
